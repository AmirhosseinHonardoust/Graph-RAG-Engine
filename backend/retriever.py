...
def _load_pickle(path: Path) -> Any:
    # Only load artifacts generated by this project. Pickle is unsafe for
    # untrusted files, so callers should not point this at external artifacts.
...
def get_store(index_dir: str | Path = IDX_DIR, model_name: str = MODEL_NAME) -> RetrieverStore:
    ...
    chunks = _load_pickle(index_dir / "chunks.pkl")
